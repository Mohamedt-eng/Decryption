...
dobel size exmpl: 
    python3 wordlist.py >> /root/Desktop/dodo.txt
"""
print(Fore.YELLOW + commet +"\033[0m")

import os, sys
ze = input(Fore.LIGHTCYAN_EX +"enter name :>" +"\033[0m")
zo = input(Fore.LIGHTCYAN_EX +"enter nechname :>"+"\033[0m")
zi = input(Fore.LIGHTCYAN_EX +"enter nme  :>"+"\033[0m")
zu = input(Fore.LIGHTCYAN_EX +"enter child :>"+"\033[0m")
za = input(Fore.LIGHTCYAN_EX +"enter ? :>"+"\033[0m")
def wordls():
    a = ["p","h","g","s","q"]
    a[0]= ze
    a[1]= zo
